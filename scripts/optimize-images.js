...
async function main() {
    ...
    console.log("");
    console.log(
        `Optimised ${touched} file(s), skipped ${skipped} already-small.`,
    );
    console.log(
        `Total: ${(totalBefore / 1024 / 1024).toFixed(1)} MB → ${(totalAfter / 1024 / 1024).toFixed(1)} MB (saved ${savedMB.toFixed(1)} MB)`,
    );
}
