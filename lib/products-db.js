...
export async function queryProducts({
  q, cat, minPrice, maxPrice, minRating = 0,
  ...
  const price = {};
  if (minPrice != null && Number(minPrice) > 0) price.gte = toCents(Number(minPrice));
  if (maxPrice != null && Number.isFinite(Number(maxPrice))) price.lte = toCents(Number(maxPrice));
