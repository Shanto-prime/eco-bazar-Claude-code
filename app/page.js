    ...
    return (
        <div className="flex justify-between items-end mb-5 sm:mb-6 gap-4">
            ...
            {href && (
                <Link
                    href={href}
                    className="text-eco-green font-medium text-sm sm:text-base whitespace-nowrap"
                >
                    {viewAllText}{" "}
...
export default async function Home() {
    ...
    const fillerCount = Math.max(
        0,
        HOT_DEALS_TOTAL_SLOTS - 1 - otherDeals.length,
    );
    const hotDealsGrid = [
        ...otherDeals,
    ...
    const heroTopBanner =
        heroTopBannerRow && isBannerLive(heroTopBannerRow)
            ? heroTopBannerRow
            : null;
    ...
    return (
        <>
          ...
          Hot Deals section further down this same page. */}
            <section className="max-w-[1320px] mx-auto px-4 sm:px-6 mt-4 sm:mt-6">
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-4 sm:gap-6">
                    <Link
                        ...
                        className="lg:col-span-8 rounded-xl overflow-hidden relative aspect-[16/11] block hover:opacity-95 transition focus:outline-none focus-visible:ring-2 focus-visible:ring-eco-green"
                    >
                        <Image
                    ...
                    <div className="lg:col-span-4 grid grid-cols-2 lg:grid-cols-1 gap-4 sm:gap-6">
                        <div className="rounded-xl overflow-hidden relative aspect-[3/2]">
                            {heroTopBanner ? (
                                <Link
                                    href={dealsHref(heroTopBanner.slug)}
                                    aria-label={heroTopBanner.title}
                                    className="block absolute inset-0 hover:opacity-95 transition focus:outline-none focus-visible:ring-2 focus-visible:ring-eco-green"
                                >
                      ...
                      plain <img> for consistency with components/PromoBanners.jsx. */}
                                    ...
                                    <img
                                        src={heroTopBanner.imageUrl}
                                        alt={heroTopBanner.title}
                        ...
                        <Link
                            href="/#hot-deals"
                            aria-label={t("home.dealOfMonthAlt")}
                            className="rounded-xl overflow-hidden relative aspect-[3/2] block hover:opacity-95 transition focus:outline-none focus-visible:ring-2 focus-visible:ring-eco-green"
                        >
                            <Image
                                src="/images/hero-special.jpg"
                                alt={t("home.dealOfMonthAlt")}
                                fill
                                className="object-cover"
                                sizes="(min-width:1024px) 33vw, 50vw"
                            />
                ...
                <div className="border border-gray-200 rounded-xl px-4 sm:px-8 py-5 sm:py-6 grid grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
                    {[
                        ...
                        },
                        {
                            ...
                            sub: t("home.securePaymentSub"),
                        },
                        {
                            icon: "fa-box",
                            title: t("home.moneyBack"),
                            sub: t("home.moneyBackSub"),
                        },
                    ].map((s) => (
                        <div
                            key={s.title}
                        ...
                        >
                            <i
                                className={`fa-solid ${s.icon} text-2xl sm:text-3xl text-eco-green`}
                            />
                            <div>
            ...
            <section
                id="hot-deals"
                className="bg-eco-bg py-10 sm:py-14 mt-10 sm:mt-14 scroll-mt-20"
            >
              ...
              takes the full width, rather than leaving a placeholder card. */}
                    <div className="grid grid-cols-1 lg:grid-cols-12 gap-4 sm:gap-5">
                        ...
                        <div
                            className={`${featuredDeal ? "lg:col-span-8" : "lg:col-span-12"} grid grid-cols-2 sm:grid-cols-4 gap-3 sm:gap-5`}
                        >
                            {hotDealsGrid.map((p) => (
                                <ProductCard
                                    key={p.slug + "-deal"}
