        ...
        <>
            <Breadcrumb
                items={[
                    {
                        href: "/shop",
                        label: t("productNotFound.breadcrumbShop"),
                    },
                    { label: t("productNotFound.breadcrumbNotFound") },
                ]}
            />
                    ...
                    <div className="mt-8 sm:mt-10 max-w-md mx-auto">
                        ...
                        >
                            ...
                            <div className="flex-1 min-w-0">
                                <div className="text-eco-green text-xs uppercase tracking-wider font-semibold">
                                    {t("productNotFound.closestMatch")}
                                </div>
            ...
            <section className="max-w-[1320px] mx-auto px-4 sm:px-6 pb-14">
                <h2 className="text-xl sm:text-2xl font-bold mb-5 sm:mb-6">
                    {suggestions?.length
                        ? t("productNotFound.youMightLike")
                        : t("productNotFound.popularProducts")}
                </h2>
