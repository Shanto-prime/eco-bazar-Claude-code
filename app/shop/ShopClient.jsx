...
export default function ShopClient({
    ...
    useEffect(() => {
        setPage(1);
    }, [query, activeCat, maxPrice, minRating, sort]);
        ...
        <div className="space-y-8">
            <form onSubmit={(e) => e.preventDefault()} className="relative">
                <input
                    ...
                    className="eco-input pr-10 rounded-full"
                />
                <button
                    type="submit"
                    className="absolute right-3 top-1/2 -translate-y-1/2 text-eco-green"
            ...
            <div>
                ...
                <div className="flex items-center gap-2 text-xs text-gray-500">
                    ...
                    <input
                        ...
                        step={1}
                        value={Math.min(
                            Math.max(maxPrice, priceBounds.min),
                            priceBounds.max,
                        )}
            ...
            <section className="max-w-[1320px] mx-auto px-4 sm:px-6 py-8 sm:py-10 grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-8">
                ...
                <div className="lg:col-span-9">
                        ...
                        <div className="mb-4 flex items-center gap-2 text-sm">
                            <span className="inline-flex items-center gap-2 rounded-full bg-eco-green/10 text-eco-green px-3 py-1 font-medium">
                                ...
                                <button
                                    type="button"
                                    onClick={() => setCat(null)}
                                    aria-label={t("shop.clearCategory")}
                                >
                    ...
                    {error ? (
                        ...
                        <div
                            className={`grid grid-cols-2 md:grid-cols-3 gap-4 sm:gap-5 transition-opacity ${loading ? "opacity-60" : ""}`}
                        >
                            {items.map((p) => (
                    ...
                    {pageCount > 1 && (
                        <div className="flex justify-center mt-8 sm:mt-10 gap-2 flex-wrap">
                            ...
                            <button
                                ...
                                className="w-9 h-9 rounded-full border hover:border-eco-green"
                    ...
                    <aside className="fixed top-0 right-0 bottom-0 w-80 max-w-[88vw] bg-white z-50 lg:hidden flex flex-col animate-[slideInRight_.2s_ease-out]">
                        ...
                        <div className="border-t p-4">
                            <button
                                type="button"
                                onClick={() => setShowFilters(false)}
                                className="w-full py-3 rounded-full bg-eco-green text-white font-medium"
                            >
