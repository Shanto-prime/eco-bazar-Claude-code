                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        <label className="block">
                            ...
                            <input
                                ...
                                className="eco-input rounded-xl font-mono"
                            />
                        </label>
                        <label className="block">
                            <span className="block text-[13px] font-medium mb-1.5">
                ...
                {order && (
                    <div className="mt-6 rounded-2xl border border-gray-200 bg-white p-5 sm:p-6">
                        <div className="flex flex-wrap items-center gap-3">
                            ...
                            <span
                                className={`text-[11px] px-2 py-0.5 rounded-full ${STATUS_PILL[order.status] || "bg-gray-100 text-gray-700"}`}
                            >
                        ...
                        <ul className="mt-4 divide-y divide-gray-100">
                            {order.items.map((it) => (
                                <li
                                    key={it.productSlug + it.productName}
                                    className="py-2.5 flex items-center gap-3 text-sm"
                                >
                                    <Link
                                        href={`/shop/${it.productSlug}`}
                                        className="hover:text-eco-green truncate"
                                    >
                                        {it.productName}
                                    </Link>
