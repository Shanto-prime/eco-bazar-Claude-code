    ...
    return (
        <header className="border-b border-gray-100 sticky top-0 bg-white z-30">
            <div className="max-w-[1320px] mx-auto px-4 sm:px-6 py-4 sm:py-5 flex items-center gap-4 sm:gap-8">
                ...
                <form
                    className="hidden md:block flex-1 max-w-[600px]"
                    onSubmit={onSearch}
                >
                    <div className="relative">
                        ...
                        <button
                            type="submit"
                            className="absolute right-1 top-1 bottom-1 px-6 bg-eco-green text-white font-medium rounded"
                        >
                            {t("common.search")}
                        </button>
                    </div>
                ...
                <div className="flex items-center gap-3 sm:gap-6 ml-auto">
                    ...
                    >
                        ...
                        {hydrated && wishlist.length > 0 && (
                            <span className="absolute -top-2 -right-2 bg-eco-green text-white text-[10px] w-4 h-4 rounded-full grid place-items-center">
                                {wishlist.length}
                            </span>
                        )}
                    </Link>
            ...
            {searchOpen && (
                <form onSubmit={onSearch} className="md:hidden px-4 pb-3 -mt-1">
                    <div className="relative">
                        ...
                        <button
                            type="submit"
                            className="absolute right-1 top-1 bottom-1 px-4 bg-eco-green text-white font-medium rounded text-sm"
                        >
                            {t("common.search")}
                        </button>
                    </div>
