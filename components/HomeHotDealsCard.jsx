...
export default function HomeHotDealsCard({ product }) {
    ...
    return (
        <div className="bg-white border border-eco-green rounded-lg p-5">
            ...
            <div className="text-center mt-4 text-eco-green font-semibold">
                {product.name}
            </div>
            ...
            <div className="text-yellow-400 text-center my-2">
                ...
                <span className="text-gray-500 text-xs">
                    {t("hotDeals.feedback", { count: 524 })}
                </span>
            </div>
            {showCountdown && (
                <>
                    <div className="text-center text-xs text-gray-500 mb-2">
                        {t("hotDeals.offerEnds")}
                    </div>
                    <div className="countdown justify-center">
                        {[
                            [t("hotDeals.days"), time[0]],
                            [t("hotDeals.hours"), time[1]],
                            [t("hotDeals.mins"), time[2]],
                            [t("hotDeals.secs"), time[3]],
                        ].map(([lbl, num], i, arr) => (
