        ...
        <div>
            <div className="flex flex-wrap items-center justify-between gap-3 mb-6">
                ...
                <Link
                    ...
                    className="inline-flex items-center gap-2 px-4 py-2 rounded-md bg-eco-green text-white text-sm min-h-[44px]"
                >
            ...
            <form className="mb-5">
                <div className="relative max-w-sm">
                    ...
                    <input
                        name="q"
                        defaultValue={q}
                        placeholder={t("dashboard.productsSearchPh")}
                ...
                {lowStockOnly && (
                    <Link
                        ...
                        className="text-xs text-eco-green mt-2 inline-block"
                    >
                            ...
                            <thead className="bg-gray-50 text-xs uppercase tracking-wider text-gray-500">
                                <tr>
                                    <th className="text-left px-4 py-3">
                                        {t("dashboard.colImage")}
                                    </th>
                                    <th className="text-left px-4 py-3">
                                        {t("dashboard.colName")}
                                    </th>
                                    <th className="text-left px-4 py-3">
                                        {t("dashboard.colPrice")}
                                    </th>
                                    <th className="text-left px-4 py-3">
                                        {t("dashboard.colStock")}
                                    </th>
                                    <th className="text-left px-4 py-3">
                                        {t("dashboard.colAddedBy")}
                                    </th>
                                    ...
                                    <tr key={p.id} className="border-t">
                                        ...
                                        <td className="px-4 py-3">
                                            <Link
                                                ...
                                                className="font-medium hover:text-eco-green"
                                            >
                                                {p.name}
                                            </Link>
                            ...
                            >
                                ...
                                <div className="flex-1 min-w-0">
                                    ...
                                    <div className="flex justify-between items-center mt-2 text-sm">
                                        ...
                                        <span
                                            className={`text-xs ${p.stock < 5 ? "text-amber-600 font-semibold" : "text-gray-500"}`}
                                        >
                                            {t("dashboard.stockLabel")}
                                            {p.stock}
                                        </span>
                                    </div>
                                </div>
