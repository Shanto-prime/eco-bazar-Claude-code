                        ...
                        <table className="w-full text-sm">
                            <thead className="bg-gray-50 text-xs uppercase tracking-wider text-gray-500">
                                <tr>
                                    ...
                                    <th className="text-left px-4 py-3">
                                        {t("dashboard.colEntity")}
                                    </th>
                                    <th className="text-left px-4 py-3">
                                        {t("dashboard.colMetadata")}
                                    </th>
                                </tr>
                            </thead>
                            <tbody>
                          ...
                          moment any audited user was deleted. */}
                                        ...
                                        <td className="px-4 py-3">
                                            <pre className="text-xs text-gray-600 whitespace-pre-wrap break-all max-w-xs">
                                                {e.metadata
                                                    ? JSON.stringify(
                                                          e.metadata,
                                                          null,
                        ...
                        {events.map((e) => (
                            ...
                            >
                                <div className="flex justify-between items-start gap-2">
                                    ...
                                    <code className="text-[10px] bg-gray-100 rounded px-1.5 py-0.5 whitespace-nowrap">
                                        {e.action}
                                    </code>
                                </div>
