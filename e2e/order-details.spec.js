...
test.describe("Order details popup", () => {
    test("customer row shows the last update and opens full history", async ({
        page,
    }) => {
        ...
        await expect(
            page.getByText(/leave the parcel at the door/i),
        ).toBeVisible(); // customer note
