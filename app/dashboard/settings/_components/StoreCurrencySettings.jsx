...
export default function StoreCurrencySettings({ currency, rates }) {
    ...
    return (
        <Card
            id="currency"
            title={t("settings.storeCurrency")}
            description={t("settings.storeCurrencyHelp")}
        >
            <form onSubmit={onSubmit}>
                <Field
                    label={t("settings.displayCurrency")}
                    hint={t("settings.displayCurrencyHint")}
                >
                    <select
                        name="currency"
                        value={selected}
                    ...
                    >
                        {CURRENCY_CODES.map((code) => (
                            <option key={code} value={code}>
                                {CURRENCIES[code].symbol.trim()} · {code}{" "}
