...
import {
  listProducts, getProductBySlug, listSuggestCandidates,
  listProductsBySlugs, listBestSellers,
} from "../../../lib/products-db";
import { getT } from "../../../lib/i18n/server";
import { findNearestProducts, isGoodSuggestion } from "../../../lib/product-suggest";
...
export default async function ProductPage({ params }) {
  ...
  if (!product) {
    ...
    const top        = nearest[0];
    const bestSlug   = top && isGoodSuggestion(slug, top) ? top.product.slug : null;
