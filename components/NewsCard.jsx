    ...
    <article className="bg-white border border-gray-100 rounded-lg overflow-hidden shadow-sm">
      ...
      <div className="p-5">
        <div className="flex items-center gap-4 text-xs text-gray-500 mb-3">
          <span><i className="fa-solid fa-tag mr-1" /> Food</span>
          <span><i className="fa-regular fa-user mr-1" /> By Admin</span>
          <span><i className="fa-regular fa-comment mr-1" /> 65 Comments</span>
        </div>
        <Link href="/blog/post" className="block font-semibold text-eco-dark hover:text-eco-green mb-4">{title}</Link>
        <Link href="/blog/post" className="text-eco-green text-sm font-medium">Read More <i className="fa-solid fa-arrow-right text-xs" /></Link>
      </div>
    </article>
  );
}
