        ...
        <nav style={{ background: "#1a2424" }} className="relative">
            <div className="max-w-[1320px] mx-auto px-4 sm:px-6 flex items-center justify-between">
                ...
                <div className="text-white flex items-center gap-2 text-sm sm:text-base">
                    ...
                    <a href="tel:2195550114" className="font-semibold">
                        (219) 555-0114
                    </a>
                </div>
            </div>
                    ...
                    >
                        ...
                        <ul className="flex-1 overflow-y-auto py-2">
                                ...
                                <li key={it.href}>
                                    <Link
                                        ...
                                        className={`block px-5 py-3 border-b border-gray-100 ${
                                            isActive(it.href)
                                                ? "text-eco-green font-medium bg-eco-bg"
                                                : "text-gray-700"
                                        }`}
                                    >
                                        {t(it.key)}
                            ...
                            <li>
                                <Link
                                    href="/cart"
                                    className="block px-5 py-3 border-b border-gray-100 text-gray-700"
                                >
                                    <i className="fa-solid fa-bag-shopping mr-2 text-eco-green" />{" "}
                                    {t("nav.cart")}
                                </Link>
                            </li>
                            <li>
                                <Link
                                    ...
                                    className="block px-5 py-3 border-b border-gray-100 text-gray-700"
                                >
                                    <i className="fa-regular fa-heart mr-2 text-eco-green" />{" "}
                                    {t("nav.wishlist")}
                                </Link>
                            </li>
                            <li>
                                <Link
                                    ...
                                    className="block px-5 py-3 border-b border-gray-100 text-gray-700"
                                >
                                    <i className="fa-regular fa-user mr-2 text-eco-green" />{" "}
                                    {t("topbar.login")}
                                </Link>
                            </li>
                            <li>
                                <Link
                                    ...
                                    className="block px-5 py-3 border-b border-gray-100 text-gray-700"
                                >
                                    <i className="fa-solid fa-gauge-high mr-2 text-eco-green" />{" "}
                                    {t("topbar.dashboard")}
                                </Link>
                            </li>
                        </ul>
                        ...
                        <div className="border-t px-5 py-4 text-sm text-gray-500">
                            <div>
                                <i className="fa-solid fa-phone text-eco-green mr-2" />{" "}
                                (219) 555-0114
                            </div>
                            <div className="mt-1">
                                <i className="fa-solid fa-envelope text-eco-green mr-2" />{" "}
                                Proxy@gmail.com
                            </div>
                        </div>
                    </aside>
