                ...
                <div className="flex justify-center gap-1.5 sm:hidden">
                    {images.map((_, i) => (
                        <button
                            ...
                            aria-label={t("gallery.goToImage", {
                                index: i + 1,
                            })}
                        />
                    ))}
                    ...
                    {images.map((img, i) => (
                        <button
                            ...
                            className={`relative flex-none w-[72px] sm:w-24 h-[72px] sm:h-24 rounded-md border-2 overflow-hidden snap-start transition ${
                                i === active
                                    ? "border-eco-green ring-1 ring-eco-green/40"
                                    : "border-gray-200 hover:border-eco-green/60"
                            }`}
...
function View({ v, alt, small = false, style }) {
    ...
    return (
        ...
        >
            ...
            {!small && v?.label && (
                <div
                    className={`absolute top-3 left-3 text-[10px] uppercase tracking-wider font-semibold px-2 py-1 rounded ${
                        v.dark
